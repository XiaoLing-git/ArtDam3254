...
from art_dam_3254.models import AnalogChannel, SwitchStatus, DigitalOutputMode, AnalogInputRange
...
if __name__ == "__main__":
    ...
    swr = BaseDriver(port="COM8",baud_rate=9600,timeout=5,device_address="01")
    swr.connect()
    ...
    res = swr.set_analog_channel_range(AnalogChannel.ch1, AnalogInputRange.V_0__2_5)
    print(res)
